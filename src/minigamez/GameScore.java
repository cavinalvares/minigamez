...
/**
 * This program is used to display the panel after the user has clicked on the score button
 * This program shows the scores of all games
 * @author Jedidiah
 *
 */
public class GameScore extends Panel implements ActionListener{
	...
	public GameScore() {
		...
		header = new JLabel();
		if(Window.mode == 0)
			setLabel(header, "Games Scores", 175, 50, 250, 50, "Serif", 25, 3);
		else
			setLabel(header, "Games Scores", (window.getWidth()-400)/2, 100, 400, 75, "Serif", 50, 3);
